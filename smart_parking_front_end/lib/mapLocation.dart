...
class _MapLocationState extends State<MapLocation>
    with AutomaticKeepAliveClientMixin<MapLocation> {
  ...
  List<ParkingLocation> parkingLocationsList = [];
    ...
    stompClient.subscribe(
      ...
      callback: (StompFrame frame) async {
        if (frame.body != null) {
          ...
          updateParkingMarkers(parkingLocationsList);
...
// Add this method to update the state inside setState
  ...
  Future<void> _updateUserLocation() async {
    try {
      ...
      parkingLocationsList = nearbyParkings!;
    ...
    if (parkingLocations.isNotEmpty) {
      ...
      for (var parkingLocation in parkingLocations) {
        ...
        markers.add(Marker(
            ...
            position:
                LatLng(parkingLocation.latitude, parkingLocation.longitude),
            icon: ParkingIcon,
            onTap: () {
